...
app.patch("/updateAboutMe", checkAuth, userController.updateAboutMe)
app.post("/createComment", checkAuth, postController.createComment)
app.post("/likePost", checkAuth, postController.likePost)
